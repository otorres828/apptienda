...
const sendWhatsAppMessage = () => {
  const message = encodeURIComponent("Saludos, mi nombre es Oliver, estoy interesado en pedir lo siguiente:\n\n- 1 Pizza grande de 6.5$\n- 2 Malteadas de chocolate de 5.4$\n\npara un total de 15$");
